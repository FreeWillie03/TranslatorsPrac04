...
public class Parser {
	...
	public const int brake_Sym = 2;
	public const int loco_Sym = 3;
	public const int coal_Sym = 4;
	public const int closed_Sym = 5;
	public const int open_Sym = 6;
	public const int cattle_Sym = 7;
	public const int coach_Sym = 8;
	public const int guard_Sym = 9;
	...
	static void Mixed() {
		...
		if (la.kind == brake_Sym) {
			...
			while (la.kind == brake_Sym || la.kind == coach_Sym || la.kind == guard_Sym) {
				HumanPart();
			}
		} else SynErr(13);
	}
	...
	static bool[,] set = {
		...
		{x,x,T,x, T,T,T,T, T,T,T,x, x},
		{x,x,x,x, T,T,T,T, x,x,T,x, x},
		{x,T,T,x, T,T,T,T, T,T,x,x, x},
		{x,x,x,x, T,T,T,T, x,x,x,x, x}
...
public class Errors {
	...
	public static void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 2: s = "\"brake\" expected"; break;
			case 3: s = "\"loco\" expected"; break;
			case 4: s = "\"coal\" expected"; break;
			case 5: s = "\"closed\" expected"; break;
			case 6: s = "\"open\" expected"; break;
			case 7: s = "\"cattle\" expected"; break;
			case 8: s = "\"coach\" expected"; break;
			case 9: s = "\"guard\" expected"; break;
			case 10: s = "\"fuel\" expected"; break;
			case 11: s = "??? expected"; break;
			case 12: s = "this symbol not expected in OneTrain"; break;
			case 13: s = "invalid Mixed"; break;
			case 14: s = "invalid HumanPart"; break;
			case 15: s = "invalid Freight"; break;
			case 16: s = "invalid Safe"; break;
